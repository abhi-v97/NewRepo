...
// Once the size is defined it can't change
    ...
    int array1[10] = {1}; // Declare an array of ints with the value of 1
...
// 3rd Number : Which row
    int array4[2][2][2] = {{{1,2}, {3,4}},
    {{5,6}, {7,8}}};
    std::cout << array4[1][1][1] << "\n";
...
// While there are more words to extract keep executing, getline takes strings from a stream of words stored in the stream and each time it finds a blanks space
